...
data class RegistrationFields(
    ...
    var registration_confirm_passsword: String? = null
) {
    ...
    fun isValidForRegistration(): String {
        if (registration_email.isNullOrEmpty()
            ...
            || registration_confirm_passsword.isNullOrEmpty()
        ) {
            return RegistrationError.mustFillAllFields()
        }
        if (!registration_password.equals(registration_confirm_passsword)) {
