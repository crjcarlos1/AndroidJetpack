...
sealed class GenericApiResponse<T> {
    ...
    companion object {
        ...
        fun <T> create(response: Response<T>): GenericApiResponse<T> {
            ...
            Log.e(TAG, "GenericApiResponse: responseCode: ${response.code()}")
            Log.e(TAG, "GenericApiResponse: response: ${response}")
            Log.e(TAG, "GenericApiResponse: raw: ${response.raw()}")
            Log.e(TAG, "GenericApiResponse: headers: ${response.headers()}")
            Log.e(TAG, "GenericApiResponse: message: ${response.message()}")
